...
func (ic *imageCopier) copyLayers(ctx context.Context) error {
	...
	copyLayerHelper := func(index int, srcLayer types.BlobInfo, toEncrypt bool, bar *pb.ProgressBar) {
		defer bar.Finish()
		...
		if ic.c.dest.AcceptsForeignLayerURLs() && len(srcLayer.URLs) != 0 {
			...
			cld.destInfo, cld.diffID, cld.err = ic.copyLayer(ctx, srcLayer, toEncrypt, bar)
		}
		data[index] = cld
	}
...
func (ic *imageCopier) copyLayer(ctx context.Context, srcInfo types.BlobInfo, toEncrypt bool, bar *pb.ProgressBar) (types.BlobInfo, digest.Digest, error) {
	...
	blobInfo, diffIDChan, err := ic.copyLayerFromStream(ctx, srcStream, types.BlobInfo{Digest: srcInfo.Digest, Size: srcBlobSize}, diffIDIsNeeded, toEncrypt, bar)
	if err != nil {
...
func (c *copier) copyBlobFromStream(ctx context.Context, srcStream io.Reader, srcInfo types.BlobInfo,
	getOriginalLayerCopyWriter func(decompressor compression.DecompressorFunc) io.Writer, canModifyBlob bool, isConfig bool, toEncrypt bool, bar *pb.ProgressBar) (types.BlobInfo, error) {
